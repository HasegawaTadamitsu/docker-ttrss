FROM arm32v7/php:7.3-apache-stretch
#COPY tmp/qemu-arm-static /usr/bin/qemu-arm-static

MAINTAINER HasegawaTadamitsu <hasegawa.tadamitsu@gmail.com>
...
RUN DEBIAN_FRONTEND=noninteractive apt-get update && apt-get install -y \
   ...
   docker-php-ext-install -j$(nproc) gd json pdo pdo_mysql pdo_pgsql intl mysqli pcntl
...
ADD sanity_check.php /var/www/include/sanity_check.php
